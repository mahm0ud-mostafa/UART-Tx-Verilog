module parity_calc #(parameter W = 8)(        // W: data width parameter, default value is 8
    input wire [W-1:0] P_INPUT,              // parallel input data (W-bit bus)
    input wire P_BIT,                         // parity type: 0 for even and 1 for odd
    output wire PARITY_BIT);                  // calculated parity bit output
